...
/**
 * Converts OperationExecutionRecords to NamedDoubleRecords. This is a backport of
 * {@link kieker.tools.opad.filter.RecordConverter} from the Kieker-1.10-SNAPSHOT-release.
 * 
 * @author Thomas D&uuml;llmann
 * @since 1.10
 * 
 */
@SuppressWarnings("javadoc")
@Plugin(description = "Converts OperationExecutionRecords to NamedDoubleRecords", outputPorts = @OutputPort(
    name = RecordConverter.OUTPUT_PORT_NAME_NDR, eventTypes = { NamedDoubleRecord.class }))
public class RecordConverter extends AbstractFilterPlugin {
   ...
   * @param projectContext controller
   */
  public RecordConverter(final Configuration configuration, final IProjectContext projectContext) {
   ...
   * 
   * @param oer OperationExecutionRecord object to be converted
   */
